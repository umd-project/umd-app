    ...
    setComponent(ele) {
        ...
        switch (this._tagname) {
            case "umd-component-audio":
                import(`${this.path}/audio/umd-component-audio.min.js`)
                    .then(_ => {
            ...
            case "umd-component-form":
                import(`${this.path}/form/umd-component-form.min.js`)
                    .then(_ => {
                        _container.appendChild(ele);
                        this.ele.removeAttribute("hidden");
                    });
            ...
            case "umd-component-image":
                import(`${this.path}/image/umd-component-image.min.js`)
                    .then(_ => {
                        _container.appendChild(ele);
                        this.ele.removeAttribute("hidden");
                    });
            ...
            case "umd-component-md":
                import(`${this.path}/md/umd-component-md.min.js`)
                    .then(_ => {
                        _container.appendChild(ele);
                        this.ele.removeAttribute("hidden");
                    });
            ...
            case "umd-component-pdf":
                import(`${this.path}/pdf/umd-component-pdf.min.js`)
                    .then(_ => {
                        _container.appendChild(ele);
                        this.ele.removeAttribute("hidden");
                    });
            ...
            case "umd-component-text":
                import(`${this.path}/components/text/umd-component-text.min.js`)
                    .then(_ => {
                        _container.appendChild(ele);
                        this.ele.removeAttribute("hidden");
                    });
            ...
            case "umd-component-video":
                import(`${this.path}/video/umd-component-video.min.js`)
                    .then(_ => {
                        _container.appendChild(ele);
                        this.ele.removeAttribute("hidden");
                    });
